...
public class SecurityConfig {
     ...
     *
     * OJO con hasRole("LIBRO"): en la base de datos el rol se guarda como
     * "ROLE_LIBRO", pero aqui se escribe SIN el prefijo. Spring lo agrega solo.
     * Si escribes hasRole("ROLE_LIBRO") buscara "ROLE_ROLE_LIBRO" y nada funcionara.
     */
    @Bean
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(configurer -> configurer
                ...
                .requestMatchers(HttpMethod.GET, "/api/libros").hasRole("LIBRO")
                .requestMatchers(HttpMethod.GET, "/api/libros/**").hasRole("LIBRO")
                // crear y modificar: solo managers
                .requestMatchers(HttpMethod.POST, "/api/libros").hasRole("MANAGER")
                .requestMatchers(HttpMethod.PUT, "/api/libros").hasRole("MANAGER")
                .requestMatchers(HttpMethod.PATCH, "/api/libros/**").hasRole("MANAGER")
                // borrar: solo admins
